...
st.set_page_config(
    page_title="ARJUN THAKUR - FB Auto",
    page_icon="🔥",
    layout="wide",
...
st.markdown('<div class="footer">MADE WITH ❤️ BY ARJUN THAKUR | © 2025</div>', unsafe_allow_html=True)
